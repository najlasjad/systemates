...
class EditNews extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final NewsController editNewsController = NewsController();
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                bool success = await editNewsController.updateNews(
            ...
            ElevatedButton(
              onPressed: () async {
                bool success = await editNewsController.deleteNews(documentId: documentId);
